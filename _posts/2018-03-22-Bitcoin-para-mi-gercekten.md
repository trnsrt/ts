...
Herhangi bir eşyanın satıcı ile alıcı arasında anlaşılır bir değeri ortaya çıktığında, alışveriş için kullanacağım bu nesnenin bu değeri tamı tamına karşılayabiliyor olması lazım. Hayatta her zaman bu kadar şanslı olmayacağımız için, genellikle elimizdeki nesnenin bir parçası bu eşyayı almak için yeterli olacak. Aksi halde elimizdeki nesneden fazla fazla vereceğiz karşı tarafa, bir nevi nesnemizin değeri düşecek. İşte bu nedenle, nesnenin alt parçalara "**Bölünebilir**" olması, onun değerini artıran özelliklerden biri. 

Bir de bu nesne ne kadar uzun süredir alışverişlerde alıcı olarak kullanılıyor ise, o kadar güvenimizi kazanır. Zira, biz insanlar görerek öğrenen ve taklid eden yaratıklarız, eğer bizden öncekiler bir sistem yaratmış ve bir nesneyi aracı olarak kullanmışlarsa (ki bizim durumumuzda devletin bastığı kağıt para ya da yastık altındaki altın) onu devam ettirmek bize "kafa rahatlığı" verir. O nedenle bir nesnenin "**Geçmişi olması**" (track record) bizim  gözümüzde değerini artırır.  

Gelelim paranın değerini artıran belki de en önemli özelliğine - belki de ilk aklınıza gelen özelliğine. Eğer para olarak kullandığımız bu nesne tabiatta bolca bulunuyorsa o zaman ne olacak? Örneğin deniz kabuğunu alışverişi aracı olarak kullansak, herhalde balıkçılar zengin olurdu! Bu nedenle kullanılan nesnenin "**Kısıtlı**" olmalı ya da ünlü bir teorisyenin dediği gibi "[üretilmesi ya da taklit edilmesi çok maliyetli](http://nakamotoinstitute.org/shelling-out/)" olmalı ki değeri yüksek olsun. Bunu biraz daha açmakta fayda var:
* Eğer bir maden ne kadar kısıtlı olursa, ya da üretmesi zor olursa o kadar değerli olur. Neden? Çünkü taklit edilemez. Taklit edilmesi zor bir nesne, kolayca gerçek olduğu anlaşılacağı için alışverişlerde "güven" içinde kullanılabilir. 
...
- Fiat paralar da fena sayılmazlar. Gerçi, yüksek rakamlı banknotlar bazen sıkıntı yaratabiliyor. Örneğin Hindistan hükümetinin kayıt dışını önlemek için 500 ve 1000 rupee banknotlarını azaltmasından sonra bu paralar piyasada iskonto görüyor. 
- Bitcoin de bu alanda fiat paralara benziyor - hatta daha dezavantaj olabilir. Bitcoin özelliği gereği takip edilebilir. Dolayısyla örneğin kara para ile ilgisi olan rakamların transferinde - özellikle büyük meblağlar söz konusu olduğunda - , Bitcoin çok da elverişli bir araç değil. 

###### Doğrulanabilirlik/Sahiclilk
- Altın, sahiciliğini kanıtlamada genelde oldukça iyi ama kimi zaman altın kaplamalı sahte madenlerin altın diye yutturulması vakaları mevcut.
- Fiat paralar ve banknotların da sahteleri ile insanların kandırıldığı örnekler maalesef hala mevcut. 
...
###### Bölünebilirlik
- Altın'ı ufak parçalara bölsek bile, en ufağı 1 gram olsa yine de oldukça yüksek bir rakam. Ekmek almak için altın kullanamayız mesela. O nedenle özellikle mikroödemeler için elverişli değil. 
- Fiat para bu anlamda gayet iyi. Kuruşlara kadar inebiliyorsunuz
- Bitcoin ise çok daha küçük parçalara inebildiği için fiat paralardan bir adım önde (her ne kadar çok ufak paraları transfer etmek komisyon rakamlarından dolayı çok mantıklı olmayabilir)

###### Kısıtlılık
- Altın, şu anda dünyada hatırı sayılır bir miktarda var ancak yeni altın arzı çok fazla beklenmiyor. Yine de teknolojideki değişimler kimi elde edilmesi zor yatakları ekonomik hale getirip arzı artırabilir
- Maalesef fiat paralar bu alanda sınıfta kaldılar. Zira para musluğu Merkez Bankaları'nın elinde ve para arzı ciddi boyutlara ulaşabiliyor
