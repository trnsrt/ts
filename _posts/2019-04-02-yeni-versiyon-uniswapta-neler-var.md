...
İki yatırımcı ETH/USDC havuzuna para yatırıyor olsunlar. Ahmet eski sistemdeki gibi tüm havuza 10,000 dolar likidite sağlasın. Ayşe ise daha akıllı bir yatırımcı olarak yeni sistemden faydalansın ve daha az bir parayı (örneğin 2,000 ABD Dolarını) belli bir fiyat aralığına yatırsın (örneğin 1ETH=1,800-2,000 USDC aralığına).. Sonrasında eğer ETH değer olarak 1,900-2,000 dolar civarında seyreder ise, havuz sadece bu kısıma yatırılmış likiditeyi alım-satım işlemlerinde kullandıracak. Ahmet parasını tüm havuz yatırdığı için bu aralığa örneğin sadece 1,500 doları düşecek. Ayşe ise daha dar bir aralıkta parasını kullandırma izni verdiği ve daha isabetli bir seçim yaptığı için sistem onun da 1,500 dolarını kullanacak. Dolayısıyla komisyon olarak hem Ahmet hem de Ayşe eşit miktara hak kazanacak. Dolayısıyla Ayşe çok daha az bir para bağlayıp Ahmet ile aynı komisyonu almış olacak!

Dolayısıyla konsantre likidite, havuza konan paranın daha verimli değerlendirilmesini sağlıyor. 
