...
- Aynı zamanda enerji bakımından maliyetli. Merkezi bir sisteminin olsa tek bir makine için harcayacağınız elektrik masrafını düşünün, bir de binlerce makinenin aynı bilgiyi tutmasından dolayı gerekecek enerjiyi.. 

- Bir yandan da oldukça geniş bir bilgi depolama alanına ihtiyacınız var. Bilginn toplam alanını bir makinede tuttuğunuzda gerekli olan depolama alanının düşünün, bir de aynı bilginin binlerce makinada tutulduğunda gerekli olan alanı.. 
