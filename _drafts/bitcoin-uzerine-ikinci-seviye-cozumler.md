...
BitVM'i kullanan çözümler teknik olarak Ethereum üzerinde zk (İngilizce 'zero-knowledge', Türkçesi 'sıfır-bilgi kanıtı') teknolojisi kullanan Starknet, zksync, Scrol ve Taiko benzeri roll-up çözümlere benziyorlar. Bitcoin üzerinde bu teknolojiyi kullanan Alpen Labs projesinin yanında ülkemizden çıkmış olan Citrea projesi dikkat çekiyor. Burada Citrea'ya kısaca değinmek istiyorum:
