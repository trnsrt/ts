...
DeFi tokenlardan kastımız merkeziyetsiz finansın değişik alanlarında ortaya çıkan platformların yarattıkları tokenlar. Ne işe yarıyorlar? Kullanım alanları farklı olsa da ait oldukları DeFi platformunun kullanımını teşvik edici özelikleri var. Genelde yönetim tokeni olmak gibi bir işlevleri var. Yani bu tokenlara sahip olanlar, DeFi platformunun iç işleyişi ve gideceği yön hakkında söz sahibi olma hakkı elde ediyorlar. 

DeFi henüz yeni gelişen bir alan olduğu için üzerine kurulu platformlar da yeni yeni gelişiyorlar. Bu nedenle bu yönetim tokenlarının hemen ortaya çıkmış ekonomik bir değerleri net olarak yok. Bu durum da aslında yavaş yavaş değişiyor. Gerek token sahiplerine verilen ekstra tokenlar, gerek yapılan işlem karşılığı belli tokenların yakılması sonucu token arzının azalması, gerekse toplanan komisyonların token sahiplerine dağıtılması gibi aktivitler tokenlara ekonomik bir değer kazandırmaya başladılar bile. 
...
Değerler oldukça yüklü hale geldiği için fırsat kaçırmak istemeyen alım-satım uzmanları ödeyecekleri ücrete bakmadan olabildiğince hızlı şekilde hareket etmeye çalıştılar. Zaten yüklü olan işlemlerin hacminin üzerine bir de bu hızlı hareket etmek isteyenler binince işlem ücretleri inanılmaz bir biçimde arttı. Neredeyse 50 doların altına işlem yapılamaz hale geldi. 
...
Alternatif zincirler birkaç nedenle daha ucuza işlem yaptırabiliyorlar. Öncelikle, kullanımları çok az olduğu için blokzincir üzerinde yerleri mevcut. Bunun yanında birçoğu Ethereum'un kulandığı Proof-of-Work yani Bitcoin'in başlattığı sistem güvenliğini madencilerin enerji harcaması ile sağlama mekanizmasını kullanmıyorlar. Daha yeni teknoloji olan Proof-of-Stake benzeri enerji harcamayan bir sistem kullanmaktalar. 
...
Polkadot, Cardano ve Avanlanche, başlangıçta Ethereum'u kuran ekipte olup sonrasında felsefi fikir ayrılıkları nedeniyle hareketten ayrılmış saygın isimlerin kurdukları projeler. Polkadot ve Avalanche gerek işlev gerekse yapmak istedikleri açısından Ethereum'a oldukça yakınlar. Hatta Avalanche Ethereum ile bir köprü kurup Ethereum üzerindeki tokenlarda bulunan değerlerin kendi blokzincirine aktarılmasına olanak vererek en büyük ağ ile olan ilişkisini iyice genişletti. Cardano ise daha çok kurumsal alanda kapalı/açık blokzincir taleplerine karşılık olmayı hedefliyor. Keza Cosmos, Polkadot benzeri farklı blokzincirler arası ortak çalışacak bir altyapı olmayı planlarken, Stellar da ödeme sistemleri konusunda kendisine bir yer kapmaya çalışıyor. 
...
Bunların hangileri başarılı olacak - şu aşamada kestirmek zor. Peki yatırım yaparken neleredikkat etmeli? İlgi kişiler, ağların piyasa değerlerinden ziyade, temel analiz anlamında, ağların geliştirici sayılarına, üzerlerine kurulu uygulamalara, bu uygulamalardaki işlem hacmine, üzerlerine kilitli değer miktarlarına ve diğer ağlar ile ilişkilerine dikkat etmeliler. Yani kısacası bir önceki yazımızda bahsettiğimiz DeFi uygulamaları için kritik olan topluluk konusu, bu tip altyapı ağlarında da çok ama çok önemli. 
...
Sistemdeki yüksek madencilik ücretlerini törpülemek ve yoğun zamanlarda blok boyutunu artırmak ile ilgili Vitalik Buterin'in o zamandan kalma EIP 1559 isimli bir iyileştirme önerisi bulunmakta. DeFi yoğunluğu ile birlikte geliştirmesi daha da hızlanan bu önerinin 2021 yaz aylarına uygulamaya konması umuluyor. 

Bunun yanında 2020 Kasım ayında başlayan ETH 2.0'in ana özelliği olan sharding'in Ethereum blokzincirini birbiri ile ortak çalışan 64 ayrı zincir haline getirmesi kapasiteyi ciddi şekilde artıracak. Bu özelliğin ise 18 ay içinde yani 2022 yılının ortalarında kullanıma hazır hale gelmesi planlanıyor. 
...
Binance ise buna çözümü, madencileri aradan çıkararak buluyor. Madencilerin yerine, Ethereum'un da yakında geçeceği sistemin bir benzeri olarak, işlem onaylayıcılarını koyuyor. Bu sayede işlemler daha az maliyet ile gerçekleşiyor. 
