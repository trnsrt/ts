...
Önceki yazımızı hazırladığımız sırada Terra sistemi, stabil parası olan UST'yi bir dolara çıpalama çabası içinde 80 cent seviyelerinde debeleniyor idi. Oldukça kısa bir süre içinde UST hızla 10 cent'e kadar indi. Bununla birlikte Terra sisteminin parası olan LUNA ise %99.99 değer kaybederek, virgülden sonraki sıfırları artık sayamayacağımız kadar atomik değerlere düştü.
...
Kayıpları yerine getirmeyecek olsa da, bu yaşananlardan belirli bazı dersler çıkarılması halinde kripto dünyasının bu krizden daha güçlü çıkabileceğine inanıyorum. Gelin bu dersler neler hızlıca bir göz atalım:

#### DeFi henüz riskli bir alan, teori ile pratik birbirine uymayabiliyor
...
DeFi alanının en saygın isimlerinden olan Delphi Digital, geçtiğimiz günlerde yayınladığı [öz-eleştiride](https://members.delphidigital.io/reports/learnings-from-last-week/) (bir nevi ingilizcedeki 'post-mortem') teoride güzel bir düşünce olan Terra konusunda nerede hata yapıldığını çok net olarak anlatmış: 

2021 yılı başlarında tanıştıkları Terra ekosisteminin, 'algoritmik stabil paralara entegre olmuş, gerçek dünya adaptasyonuna odaklanmış ve göreceli ölçeklenebilir bir blokzincir olma' tezini çok ilgi çekici bulmuşlar. Sonrasında ortaya çıkan Anchor protokolünün ise geniş kesimlerce adaptasyon hedefi nedeniyle bu teze müthiş uyumlu olduğunu düşünmüşler. O zamanlarda DeFi'de getiriler genelde %100'ler seviyesinde olduğu için Anchorsun verdiği %20'lik faiz onlara gayet makul görünmüş. 

Ne ki, 2022 yılı başlarında DeFi'de getiriler hızla düşerken, Anchor'un bu oranı sürdürmesi sistemde ciddi bir para toplanmasına neden oldu. Verilen yüksek faiz sonucu oluşan açık başlangıçta Anchor rezervlerinden karşılanırken, sonrasında bu mümkün olmadı. Hızlı büyüme nedeniyle oluşan kırılganlık, özellikle piyasanın kötü olduğu dönemlerde ölümcül hale gelebiliyor. Bunu önlemek için alınan önlem 'rezervlere BTC atalım' oldu. Teoride makul görünen bu önlemin, piyasanın kötü dönemlerinde kullanıldığında BTC'nin fiyatını daha da düşürerek aslında hiç de göründüğü kadar yeterli olmadığı görüldü. 
...
Son günlerde yakın çevremdeki pek çok kişiden 'bu olay DeFi'yi çok yaraladı' şeklinde yorumlar duyuyorum. Şahsen bu konuda genel oluşan havanın aksine bir görüşteyim. Yaşananları DeFi'nin büyümesi sırasında yaşanan en büyük krizlerden biri olarak görmek gerek. Aynı şekilde bu krizin DeFi'nin geniş kesimlerce adaptasyonunu geciktireceğini de kabul etmeli. 
